    ...
    <div class="site-navbar__body clearfix">
      ...
      <el-menu class="site-navbar__menu site-navbar__menu--right" mode="horizontal">
        <el-menu-item class="site-navbar__avatar sd-sizes" index="3">
          <el-badge :value="message!=undefined?message.userCount:''" class="item" v-if="$GlobalApi.getUserInfo().roleId == 10">
            <el-button @click="userSubmit" icon="el-icon-chat-dot-round" size="small" type="text">用户提现</el-button>
          </el-badge>
          <el-badge :value="message!=undefined?message.merchantCount:''" class="item" v-if="$GlobalApi.getUserInfo().roleId == 10">
