          ...
          <el-row style="margin-top: 20px;">
            <el-col :span="15" :offset="2">
              <el-form :model="business" :rules="rules" ref="business" label-width="200px">
                ...
                <el-form-item label="权重值" prop="priority">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        directsContactPhone: [{ required: true, message: "请输入联系电话" }]
      },
      openMap: false,
    ...
    submitForm() {
      this.$refs['business'].validate(async valid => {
        if (valid) {
          try {
            this.$http({
              url: this.$http.adornUrl('/directs/add'),
              method: 'post',
              data: this.$http.adornData({
                "directsAvatarFile":this.businessAvatar,
